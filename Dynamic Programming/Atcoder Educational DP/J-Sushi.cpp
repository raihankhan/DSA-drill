...
// dp[a][b][c] - number of expected operations when there's 1 sushi on a plate, 2 sushi on b plate and 3 sushi on c plate
...
double solve(int a,int b,int c)
{
    ...
    double tot = a+b+c;
    double rest = n/tot;       // ( empty plates + plates with sushi) / total states
    double pa = a/tot;
    double pb = b/tot;
    double pc = c/tot;
