...
/*
dp[i][j] = on i'th coin toss j heads attained
dp[1][0] =  T    , dp[1][1] = H
dp[2][0] =  TT   , dp[2][1] = TH + HT = dp[1][0]*head[2] +  dp[1][1]*tail[2]
dp[3][0] =  TTT  , dp[3][1] = TTH + THT + HTT = TTH + (TH + HT)*T = dp[2][0]*head[3] +  dp[1][1]*tail[3]
